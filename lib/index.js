...
var isBuffer = function isBuffer(value) {
  ...
  if (!_lodash.default.isBuffer(value)) {
    throw new Error("".concat(msg, ": expected ").concat(value, " to be buffer"));
  }
};
...
var isInteger = function isInteger(value) {
  ...
  if (!Number.isInteger(value)) {
    throw new Error("".concat(msg, ": expected ").concat(value, " to be integer"));
  }
};
...
var isZreo = function isZreo(value) {
  ...
  if (value !== 0) {
    throw new Error("".concat(msg, ": expected ").concat(value, " to be zreo"));
  }
};
...
var isPositive = function isPositive(value) {
  ...
  if (value < 0) {
    throw new Error("".concat(msg, ": expected ").concat(value, " to be positive number"));
  }
};
...
var isNegative = function isNegative(value) {
  ...
  if (value > 0) {
    throw new Error("".concat(msg, ": expected ").concat(value, " to be negative number"));
  }
};
...
var _matchCount = function _matchCount(value, reg, count) {
  ...
  if (!result || result.length !== count) {
    throw new Error("".concat(msg, ": expected ").concat(value, " match ").concat(reg, " to be ").concat(count, " result"));
  }
};
