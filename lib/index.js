...
var isInteger = function isInteger(value) {
  ...
  if (!Number.isInteger(value)) {
    throw new Error("".concat(msg, ": expected ").concat(value, " to be a integer"));
  }
};
...
var isZreo = function isZreo(value) {
  ...
  if (value !== 0) {
    throw new Error("".concat(msg, ": expected ").concat(value, " to be a zreo"));
  }
};
...
var isPositive = function isPositive(value) {
  ...
  if (value < 0) {
    throw new Error("".concat(msg, ": expected ").concat(value, " to be a positive number"));
  }
};
...
var isNegative = function isNegative(value) {
  ...
  if (value > 0) {
    throw new Error("".concat(msg, ": expected ").concat(value, " to be a negative number"));
  }
};
...
var _decimal2 = function decimal(value, _decimal) {
  ...
  if (d !== _decimal) {
    throw new Error("".concat(msg, ": expected ").concat(value, " decimal to be ").concat(_decimal));
  }
};
...
var isDigital = function isDigital(value) {
  ...
  if (isNaN(value)) {
    throw new Error("".concat(msg, ": expected ").concat(value, " to be digital"));
  }
};
...
var _matchCount = function _matchCount(value, reg, count) {
  ...
  if (result.length !== count) {
    throw new Error("".concat(msg, ": expected ").concat(value, " match ").concat(reg, " to ").concat(count, " result"));
  }
};
        ...
        case 'typeOfIn':
          {
            ...
            try {
              for (var _iterator = argument[1][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                try {
                  _chai.assert.typeOf(argument[0], _value);
            ...
            throw new Error("".concat(argument[2], ": expected ").concat(argument[0], ":").concat(getType(argument[0]), " type in [").concat(argument[1], "]"));
            break;
          }
